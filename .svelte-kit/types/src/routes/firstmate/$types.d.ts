...
type LayoutRouteId = RouteId | "/firstmate"
...
export type LayoutServerData = Expand<OptionalUnion<EnsureDefined<Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../src/routes/firstmate/+layout.server.js').load>>>>>>;
