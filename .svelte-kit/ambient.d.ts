...
declare module '$env/static/private' {
	...
	export const MJ_APIKEY_PUBLIC: string;
	export const MJ_APIKEY_PRIVATE: string;
	...
	export const AUDIT_WEBHOOK_BASE: string;
	export const AUDIT_WEBHOOK_ID: string;
	export const AUDIT_WEBHOOK_URL: string;
	export const EMAIL_SERVICE_URL: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		JWT_SECRET: string;
		AUDIT_WEBHOOK_BASE: string;
		AUDIT_WEBHOOK_ID: string;
