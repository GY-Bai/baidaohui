...
var NavBar, nicknameRegex, NicknameDialog, userRole, Layout;
var init_layout_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/_layout.svelte.js"() {
    ...
    nicknameRegex = /^[\u4e00-\u9fa5a-zA-Z\u{1F600}-\u{1F64F}\u{1F300}-\u{1F5FF}\u{1F680}-\u{1F6FF}\u{1F1E0}-\u{1F1FF}\u{2600}-\u{26FF}\u{2700}-\u{27BF}]+$/u;
    NicknameDialog = create_ssr_component(($$result, $$props, $$bindings, slots) => {
        ...
        try {
          ...
          if (!response.ok) {
            if (response.status === 409) {
              error2 = "\u6635\u79F0\u5DF2\u88AB\u5360\u7528\uFF0C\u8BF7\u9009\u62E9\u5176\u4ED6\u6635\u79F0";
            } else {
              error2 = data.message || "\u9A8C\u8BC1\u5931\u8D25\uFF0C\u8BF7\u91CD\u8BD5";
            }
          } else {
...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    ...
    imports = ["_app/immutable/nodes/0.2829ccaf.js", "_app/immutable/chunks/scheduler.a1aa4b3e.js", "_app/immutable/chunks/index.e0a59431.js"];
    stylesheets = ["_app/immutable/assets/0.a1239d76.css"];
    fonts = [];
  }
});
...
var init__2 = __esm({
  ".svelte-kit/output/server/nodes/1.js"() {
    ...
    imports2 = ["_app/immutable/nodes/1.f752cf12.js", "_app/immutable/chunks/scheduler.a1aa4b3e.js", "_app/immutable/chunks/index.e0a59431.js", "_app/immutable/chunks/singletons.9287b66d.js"];
    stylesheets2 = [];
    fonts2 = [];
  }
});
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/2.js"() {
    ...
    imports3 = ["_app/immutable/nodes/2.076d3d83.js", "_app/immutable/chunks/scheduler.a1aa4b3e.js", "_app/immutable/chunks/index.e0a59431.js"];
    stylesheets3 = ["_app/immutable/assets/2.98433c5a.css"];
    fonts3 = [];
  }
});

// .svelte-kit/output/server/entries/pages/chat/_page.svelte.js
...
var init_page_svelte2 = __esm({
  ".svelte-kit/output/server/entries/pages/chat/_page.svelte.js"() {
    ...
    Page2 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `${$$result.head += `<!-- HEAD_svelte-1yx4ibq_START -->${$$result.title = `<title>\u79C1\u4FE1 - \u767E\u5200\u4F1A</title>`, ""}<!-- HEAD_svelte-1yx4ibq_END -->`, ""} <div class="max-w-4xl mx-auto px-4 py-8"><div class="text-center"> <div class="mx-auto h-24 w-24 rounded-full bg-gradient-to-r from-blue-100 to-purple-100 flex items-center justify-center mb-6" data-svelte-h="svelte-ninxsq"><span class="text-4xl">\u{1F4AC}</span></div> <h1 class="text-3xl font-bold text-gray-900 mb-4" data-svelte-h="svelte-8vxpx6">\u79C1\u4FE1\u529F\u80FD</h1>  <div class="max-w-md mx-auto"><div class="bg-yellow-50 border border-yellow-200 rounded-lg p-6 mb-6"><div class="flex items-center justify-center mb-4" data-svelte-h="svelte-1g64dvy"><svg class="h-8 w-8 text-yellow-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.732-.833-2.5 0L4.268 18.5c-.77.833.192 2.5 1.732 2.5z"></path></svg></div> <h3 class="text-lg font-semibold text-yellow-800 mb-2" data-svelte-h="svelte-12ox82n">\u5347\u7EA7\u4E3A Member \u4EE5\u542F\u7528\u804A\u5929\u529F\u80FD</h3> <p class="text-yellow-700 mb-4" data-svelte-h="svelte-1nh64i9">\u60A8\u5F53\u524D\u662F Fan \u7528\u6237\uFF0C\u9700\u8981\u5347\u7EA7\u4E3A Member \u624D\u80FD\u4F7F\u7528\u79C1\u4FE1\u529F\u80FD\u4E0E\u4E3B\u64AD\u4EA4\u6D41\u3002</p> <div class="space-y-3"><button class="w-full bg-yellow-600 text-white px-4 py-2 rounded-md font-medium hover:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2 transition-colors duration-200" data-svelte-h="svelte-7xbkjc">\u4E86\u89E3\u5982\u4F55\u5347\u7EA7</button> <button class="w-full bg-white text-yellow-700 px-4 py-2 rounded-md font-medium border border-yellow-300 hover:bg-yellow-50 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2 transition-colors duration-200" data-svelte-h="svelte-d3z2jv">\u8054\u7CFB\u4E3B\u64AD</button></div></div>  <div class="bg-gray-50 rounded-lg p-4" data-svelte-h="svelte-7n3q2w"><h4 class="font-medium text-gray-900 mb-2">Member \u4E13\u4EAB\u529F\u80FD</h4> <ul class="text-sm text-gray-600 space-y-1"><li class="flex items-center"><svg class="h-4 w-4 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
            \u4E0E\u4E3B\u64AD\u79C1\u4FE1\u4EA4\u6D41</li> <li class="flex items-center"><svg class="h-4 w-4 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
            \u67E5\u770B\u7FA4\u804A\u6D88\u606F</li> <li class="flex items-center"><svg class="h-4 w-4 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
            \u5B9E\u65F6\u6D88\u606F\u901A\u77E5</li> <li class="flex items-center"><svg class="h-4 w-4 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg>
            \u4F18\u5148\u7B97\u547D\u670D\u52A1</li></ul></div></div></div></div>`;
    });
  }
});
...
var init__4 = __esm({
  ".svelte-kit/output/server/nodes/3.js"() {
    ...
    imports4 = ["_app/immutable/nodes/3.5f4aae5c.js", "_app/immutable/chunks/scheduler.a1aa4b3e.js", "_app/immutable/chunks/index.e0a59431.js"];
    stylesheets4 = [];
    fonts4 = [];
  }
});

// .svelte-kit/output/server/entries/pages/fortune/_page.svelte.js
...
var init_page_svelte3 = __esm({
  ".svelte-kit/output/server/entries/pages/fortune/_page.svelte.js"() {
    ...
    Page3 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      $$result.css.add(css2);
      return `${$$result.head += `<!-- HEAD_svelte-1my3sla_START -->${$$result.title = `<title>\u767E\u5200\u4F1A - \u7B97\u547D</title>`, ""}<meta name="description" content="\u767E\u5200\u4F1A\u7B97\u547D\u670D\u52A1"><!-- HEAD_svelte-1my3sla_END -->`, ""} <div class="container svelte-xx7ncv" data-svelte-h="svelte-1j2jkou"><h1 class="svelte-xx7ncv">\u{1F52E} \u7B97\u547D\u670D\u52A1</h1> <p class="svelte-xx7ncv">\u7B97\u547D\u529F\u80FD\u6B63\u5728\u5F00\u53D1\u4E2D...</p> </div>`;
    });
  }
});
...
var init__5 = __esm({
  ".svelte-kit/output/server/nodes/4.js"() {
    ...
    imports5 = ["_app/immutable/nodes/4.701edb3b.js", "_app/immutable/chunks/scheduler.a1aa4b3e.js", "_app/immutable/chunks/index.e0a59431.js"];
    stylesheets5 = ["_app/immutable/assets/4.d00b59ad.css"];
    fonts5 = [];
  }
});

// .svelte-kit/output/server/entries/pages/fortune/new/_page.svelte.js
...
var init_page_svelte4 = __esm({
  ".svelte-kit/output/server/entries/pages/fortune/new/_page.svelte.js"() {
    ...
    Page4 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<div class="min-h-screen bg-gray-50 py-8"><div class="max-w-2xl mx-auto px-4">${``}  <div class="bg-white rounded-lg shadow-md p-6 opacity-50"><h1 class="text-2xl font-bold text-gray-900 mb-6" data-svelte-h="svelte-1en9lfd">\u63D0\u4EA4\u7B97\u547D\u7533\u8BF7</h1>  <div class="mb-6" data-svelte-h="svelte-6c3lk0"><label class="block text-sm font-medium text-gray-700 mb-2">\u4E0A\u4F20\u56FE\u7247 (\u6700\u591A3\u5F20)</label> <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center"><button type="button" disabled class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-gray-400 cursor-not-allowed">\u9009\u62E9\u56FE\u7247</button> <p class="mt-2 text-sm text-gray-500">\u652F\u6301 JPG\u3001PNG \u683C\u5F0F\uFF0C\u5355\u5F20\u56FE\u7247\u4E0D\u8D85\u8FC7 5MB</p></div></div>  <div class="mb-6" data-svelte-h="svelte-lmo4dd"><label for="description" class="block text-sm font-medium text-gray-700 mb-2">\u9644\u8A00 (0/800\u5B57)</label> <textarea id="description" disabled rows="6" class="w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-100 cursor-not-allowed" placeholder="\u8BF7\u8BE6\u7EC6\u63CF\u8FF0\u60A8\u7684\u95EE\u9898..."></textarea></div>  <div class="mb-6"><label class="block text-sm font-medium text-gray-700 mb-2" data-svelte-h="svelte-16iaubo">\u91D1\u989D</label> <div class="flex space-x-4"><div class="flex-1" data-svelte-h="svelte-cq9349"><input type="number" disabled class="w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-100 cursor-not-allowed" placeholder="\u8BF7\u8F93\u5165\u91D1\u989D"></div> <div class="w-32"><select disabled class="w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-100 cursor-not-allowed"><option value="\xA5 \u4EBA\u6C11\u5E01" data-svelte-h="svelte-1vkcrx7">\xA5 \u4EBA\u6C11\u5E01</option></select></div></div></div>  <div class="mb-6" data-svelte-h="svelte-1auf1cx"><label class="flex items-center"><input type="checkbox" disabled class="h-4 w-4 text-gray-400 border-gray-300 rounded cursor-not-allowed"> <span class="ml-2 text-sm text-gray-500">\u5C0F\u5B69\u5371\u6025\u60C5\u51B5\uFF08\u4F18\u5148\u5904\u7406\uFF09</span></label></div>  <div class="flex justify-end space-x-4"><button type="button" class="px-4 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50" data-svelte-h="svelte-12ghdj7">\u8FD4\u56DE</button> <button type="button" disabled class="px-6 py-2 bg-gray-400 text-white rounded-md cursor-not-allowed" data-svelte-h="svelte-19zcyjc">\u63D0\u4EA4\u7533\u8BF7</button></div></div></div></div>`;
    });
  }
});
...
var init__6 = __esm({
  ".svelte-kit/output/server/nodes/5.js"() {
    ...
    imports6 = ["_app/immutable/nodes/5.eecaf5dc.js", "_app/immutable/chunks/scheduler.a1aa4b3e.js", "_app/immutable/chunks/index.e0a59431.js", "_app/immutable/chunks/singletons.9287b66d.js"];
    stylesheets6 = [];
    fonts6 = [];
  }
});
...
var init_page_svelte5 = __esm({
  ".svelte-kit/output/server/entries/pages/profile/_page.svelte.js"() {
    ...
    Page5 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      $$result.css.add(css3);
      return `${$$result.head += `<!-- HEAD_svelte-1dk50qs_START -->${$$result.title = `<title>\u767E\u5200\u4F1A - \u4E2A\u4EBA\u8D44\u6599</title>`, ""}<meta name="description" content="\u767E\u5200\u4F1A\u4E2A\u4EBA\u8D44\u6599"><!-- HEAD_svelte-1dk50qs_END -->`, ""} <div class="container svelte-xx7ncv" data-svelte-h="svelte-13ixgo"><h1 class="svelte-xx7ncv">\u{1F464} \u4E2A\u4EBA\u8D44\u6599</h1> <p class="svelte-xx7ncv">\u4E2A\u4EBA\u8D44\u6599\u529F\u80FD\u6B63\u5728\u5F00\u53D1\u4E2D...</p> </div>`;
    });
  }
});
...
var init__7 = __esm({
  ".svelte-kit/output/server/nodes/6.js"() {
    ...
    imports7 = ["_app/immutable/nodes/6.e026bcbf.js", "_app/immutable/chunks/scheduler.a1aa4b3e.js", "_app/immutable/chunks/index.e0a59431.js"];
    stylesheets7 = ["_app/immutable/assets/4.d00b59ad.css"];
    fonts7 = [];
  }
});

// .svelte-kit/output/server/entries/pages/shop/_page.svelte.js
...
var init_page_svelte6 = __esm({
  ".svelte-kit/output/server/entries/pages/shop/_page.svelte.js"() {
    ...
    Page6 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      $$result.css.add(css4);
      return `${$$result.head += `<!-- HEAD_svelte-1yz5hxr_START -->${$$result.title = `<title>\u767E\u5200\u4F1A - \u5546\u5E97</title>`, ""}<meta name="description" content="\u767E\u5200\u4F1A\u597D\u7269\u63A8\u8350"><!-- HEAD_svelte-1yz5hxr_END -->`, ""} <div class="container svelte-xx7ncv" data-svelte-h="svelte-1phkvfj"><h1 class="svelte-xx7ncv">\u{1F6CD}\uFE0F \u597D\u7269\u63A8\u8350</h1> <p class="svelte-xx7ncv">\u5546\u5E97\u529F\u80FD\u6B63\u5728\u5F00\u53D1\u4E2D...</p> </div>`;
    });
  }
});
...
var init__8 = __esm({
  ".svelte-kit/output/server/nodes/7.js"() {
    ...
    imports8 = ["_app/immutable/nodes/7.e194c2ff.js", "_app/immutable/chunks/scheduler.a1aa4b3e.js", "_app/immutable/chunks/index.e0a59431.js"];
    stylesheets8 = ["_app/immutable/assets/4.d00b59ad.css"];
    fonts8 = [];
  }
});
...
var manifest = (() => {
  ...
  return {
    appDir: "_app",
    appPath: "_app",
    assets: /* @__PURE__ */ new Set(["apple-touch-icon-precomposed.png", "apple-touch-icon.png", "assets/pic/favicon.png", "favicon.ico", "favicon.png"]),
