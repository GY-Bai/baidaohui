...
class ChatModuleSimple extends HookWidget {
  final UserRole userRole;
  final String? groupId;
  final bool showFanMessages;

  const ChatModuleSimple({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    MessageType getUserMessageType() {
      switch (userRole) {
        case UserRole.fan:
        ...
        children: [
          ...
          Expanded(
            child: ListView(
              ...
              children: filteredMessages.map((message) => buildMessageItem(message)).toList(),
            ),
          ),
        ...
        children: [
          Row(
            children: [
              ...
              const SizedBox(width: 8),
              buildMessageTypeChip(message.messageType),
              const Spacer(),
              Text(
  ...
  Widget buildMessageTypeChip(MessageType type) {
    String text;
    Color color;
